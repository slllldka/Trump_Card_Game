...
서버: JAVA, C#을 사용하여 개발(소켓 프로그래밍)<br>
...
### 서버와 클라이언트가 같은 Private Network에 속해있을 때만 PVP 기능을 이용할 수 있는 문제
- AWS EC2 인스턴스를 통해 공인 IP에서 서버 실행<br>
- 이후 PVP 게임 시작 시 UDP 홀 펀칭을 먼저 시도<br>
...
이를 C#을 사용해서 클라이언트로 이식하여<br>
클라이언트에서 로컬 서버를 열 수 있는 방식으로도 구현해보았음<br>
